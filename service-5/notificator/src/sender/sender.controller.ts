...
export class SenderController {
    ...
    @Post('/telegram')
    @ApiOperation({summary: "Надіслати повідомлення юзеру через телеграм бота по чат ід"})
    async sendMessageToTelegramUser(@Body() data: SendTeleramMessage): Promise<void>{
